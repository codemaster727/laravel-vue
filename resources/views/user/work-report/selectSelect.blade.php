<!DOCTYPE html>
<html>
<?php require_once($_SERVER['DOCUMENT_ROOT'] . '/views/common/head.php'); ?>
<body>

    <div id="app">
        <?php require_once($_SERVER['DOCUMENT_ROOT'] . '/views/common/header-user.php'); ?>
        <main>
                ...
                <div class="l-wrap--inner">
                    <div class="l-wrap--header">
                        <div class="l-wrap--header__inner">
                            ...
                            <h1 class="l-wrap--header__title">PDF用写真を選択する</h1>
                        </div>
                    </div>
                                        ...
                                        <label class="l-select__wrap l-flex">
                                            ...
                                            <div class="l-select__detail l-flex">
                                                <div class="c-detail--img">
                                                    <img src="/public/img/384597_s.png">
                                                </div>
